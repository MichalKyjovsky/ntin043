...
NonActive(shopper) == /\ shopperState[shopper] = "idle"
                      /\ (shopperState' = [shopperState EXCEPT ![shopper] = "served"] \/ shopperState' = [shopperState EXCEPT ![shopper] = "selecting"])
                      /\ UNCHANGED << availableProducts, customers, commodities, boughtProducts, commodity, availableProductsSet, availableProductsIndex, bought >>
...
Terminating == /\ \A self \in Shoppers: shopperState \in {"served", "idle"}
               /\ UNCHANGED vars
...
Termination == <>(\A shopper \in Shoppers: shopperState[shopper] \in {"served", "idle"})
