...
TCInint == /\ shopperState = [shopper \in Shoppers |-> "browsing"]
           ...
           /\ commodity = [shopper \in ProcSet |-> 0]
...
Terminating == /\ (\A shopper \in ProcSet: shopperState[shopper] = "served") 
               /\ UNCHANGED vars
...
Termination == <>(\A shopper \in ProcSet: shopperState[shopper] = "served")
